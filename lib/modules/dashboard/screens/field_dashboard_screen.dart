...
class FieldDashboardScreen extends GetView<FieldDashboardController> {
  ...
  Widget _buildWelcomeHeader() {
    ...
    return Builder(
      builder: (context) => PremiumAnimations.fadeInScale(
        child: Container(
                ...
                PremiumAnimations.slideIn(
                  ...
                  child: Container(
                    padding: EdgeInsets.symmetric(
                      ...
                      vertical: ResponsiveUtils.isMobile(context) ? 5 : 6,
                    ),
                    decoration: BoxDecoration(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: ResponsiveUtils.isMobile(context) ? 13 : 14,
                      ),
                    ),
                  ),
                ),
  ...
  Widget _buildDashboardTile({
    ...
    return Builder(
      builder: (context) => PremiumAnimations.bounceTouch(
        onTap: onTap,
        child: PremiumCard(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Container(
                  width: ResponsiveUtils.isMobile(context) ? 32 : 36,
                  height: ResponsiveUtils.isMobile(context) ? 32 : 36,
                  decoration: BoxDecoration(
                    color: color.withValues(alpha: 0.1),
                    borderRadius: BorderRadius.circular(
                      ResponsiveUtils.isMobile(context) ? 8 : 10,
                    ),
                  ),
                  child: Icon(
